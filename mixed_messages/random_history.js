const wowProfessions = ["Alchemist", "Blacksmither", "Enchanter", "Engineer", "Herbalist", "Inscriptioneer", "Jewelcrafter", "Leatherworker", "Miner", "Skinner", "Tailored", "Archaeologhist", "Chef", "Fisher", "First Aider"];
  ...
  const wowSyllables = ["ar", "an", "as", "ath", "al", "ad", "ag", "am", "az", "ak", "er", "en", "el", "eth", "ed", "eg", "em", "ez", "ek", "ir", "in", "il", "ith", "id", "ig", "im", "iz", "ik", "or", "on", "ol", "oth", "od", "og", "om", "oz", "ok", "ur", "un", "ul", "uth", "ud", "ug", "um", "uz", "uk", "ba", "be", "bi", "bo", "bu", "da", "de", "di", "do", "du",
    "ga", "ge", "gi", "go", "gu", "ka", "ke", "ki", "ko", "ku", "la", "le", "li", "lo", "lu", "ma", "me", "mi", "mo", "mu", "na", "ne", "ni", "no", "nu", "pa", "pe", "pi", "po", "pu",
    "ra", "re", "ri", "ro", "ru", "sa", "se", "si", "so", "su", "ta", "te", "ti", "to", "tu", "va", "ve", "vi", "vo", "vu", "za", "ze", "zi", "zo", "zu"];
...
let profession = random_profession()
let place=random_place()
